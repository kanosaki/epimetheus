...
abstract class InterpreterTracer {
    ...
    companion object {
        val empty = object : InterpreterTracer() {}
    }
...
class PhaseInterpreterTracer : InterpreterTracer() {
...
class TimingInterpreterTracer : InterpreterTracer() {
...
class FullLoggingInterpreterTracer : InterpreterTracer() {
    private var beginTime: Long? = null
